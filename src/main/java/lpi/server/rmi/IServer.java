...
public interface IServer extends Remote {
     ...
     * @throws RemoteException   in case of communication issues.
     * @throws LoginException    if the provided password does not match to the login that was
     *                           already provided before.
     * @throws ArgumentException if the specified <b>login</b> or <b>password</b> are not
     *                           valid.
     ...
     *
     * @param sessionId The session id assigned to you after <b>login</b> call.
     * @return An array of user names.
     * @throws RemoteException   in case of communication issues.
     * @throws ArgumentException if the specified <b>sessionId</b> is not valid.
     * @throws ServerException   if the server failed to process the request.
     */
     ...
     *
     * @param sessionId The session id assigned to you after <b>login</b> call.
     * @param msg       An message object that contains message information.
     * @throws RemoteException   in case of communication issues.
     * @throws ArgumentException if the specified <b>sessionId</b> or <b>msg</b> are not
     *                           valid.
     * @throws ServerException   if the server failed to process the request.
     */
     ...
     *
     * @param sessionId The session id assigned to you after <b>login</b> call.
     * @param file      The file information that should be delivered to the receiver.
     * @throws RemoteException   in case of communication issues.
     * @throws ArgumentException if the specified <b>sessionId</b> or <b>file</b> are not
     *                           valid.
     * @throws ServerException   if the server failed to process the request.
     */
    ...
    public static class Message implements Serializable {
         ...
         * specified.
         *
         * @param receiver The targeted receiver of the message.
         * @param message  The message itself (content).
         */
         ...
         *
         * @param sender A <b>String</b> that specifies the sender of the message.
         */
         ...
         *
         * @param receiver A <b>String</b> that specifies the receiver of the
         *                 message.
         */
         ...
         *
         * @param message A <b>String</b> that specifies the message that should be
         *                delivered to the receiver.
         */
    ...
    public static class FileInfo implements Serializable {
         ...
         * specified.
         *
         * @param receiver The receiver that the file should be delivered to.
         * @param file     The <b>File</b> object that points to a file that should
         *                 be transferred to receiver.
         * @throws IOException if the system failed to read or process the file.
         */
         ...
         *
         * @param receiver The receiver that the file should be delivered to.
         * @param sender   The sender that is sending this file.
         * @param filename The name of the file that should be transferred (usually
         ...
         *
         * @param sender A <b>String</b> that defines the sender of the file.
         */
        public void setSender(String sender) {
            this.sender = sender;
        }
         ...
         *
         * @param receiver A <b>String</b> that defines the receiver of the file.
         */
        public void setReceiver(String receiver) {
            this.receiver = receiver;
        }
         ...
         *
         * @param filename A <b>String</b> that defines the name of the file (only
         ...
         *
         * @param fileContent An array of bytes that define the content of the file.
         */
         ...
         *
         * @param location A <b>File</b> that specifies either the existing folder or
         *                 the full path where the file should be saved. In case the
         *                 complete filename is specified, the file will be
         *                 rewritten.
         * @throws IOException If the system failed to save the file to a specified
         *                     location.
         */
